...
class GuessNumbers(models.Model):  # 상속 받아주고 / 거의 디폴트로
    name = models.CharField(max_length=24) # 로또 번호 리스트의 이름 # Availabe form list
...
#       return "pk {} : {} - {}".format(self.id, self.name, self.text) # pk는 자동생성됨
